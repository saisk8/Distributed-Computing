...
public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (true) {
                ...
                DatagramPacket ackPacket = new DatagramPacket(ackData, receiveData.length);
                ...
                do {
                        try {
                                // Wait for reception of ack and display the result to the user
                                // Receive response
                ...
                if (receivedResponse) {
                        ...
                        System.out.println("No Acknowlegement received from the client");
                }
        }
}
